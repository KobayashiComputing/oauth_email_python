# W3Tutorials: Send Gmail with Python and OAuth2
Here is a link to the original article (I've copied the text of the article to the file 'TUTORIAL.md'):
...
## From WP Mail SMTP Documentation
