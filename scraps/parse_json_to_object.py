...
print("     Project ID   : ", obj.oauth2_google.web.project_id)
print("     Client ID    : ", obj.oauth2_google.web.client_id)
print("     Client Secret: ", obj.oauth2_google.web.client_secret)
